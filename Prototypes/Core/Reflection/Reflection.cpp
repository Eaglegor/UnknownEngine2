...
template < typename T > class TypedObjectHolder:public ObjectRefHolder
{
  public:
...
{
  public:
	template < typename Cls, typename T > void setValue(Cls * cls, const T & value)
	{
  ...
  private:
	void setValueImpl(ObjectRefHolder & object_holder, ObjectRefHolder value_holder) = 0;
};

template < typename T > class BaseMetaType:public IMetaType
{
  public:
...
template < typename T, typename BaseClass > class BaseDerivedMetaType:public BaseMetaType < T >
{
  ...
  protected:
	  BaseDerivedMetaType(const char *name, ClassType type):BaseMetaType < T > (name, type)
	{
...
template <> class MetaType < int >:public BaseMetaType < int >
{
  public:
...
template <> class MetaType < float >:public BaseMetaType < float >
{
  public:
...
template <> class MetaType < A >:public BaseMetaType < A >
{
  public:
...
template <> class MetaType < B >:public BaseMetaType < B >
{
  public:
...
template <> class MetaType < C >:public BaseDerivedMetaType < C, B >
{
  public:
...
template <> class MetaType < D >:public BaseDerivedMetaType < D, C >
{
  public:
