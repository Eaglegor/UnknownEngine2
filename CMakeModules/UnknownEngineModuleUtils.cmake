...
macro(add_third_party_dependency library_name version platform)
	include(${UNKNOWN_ENGINE_SOURCE_DIR}/ThirdParty/${library_name}/${version}/${platform}/add.cmake)
	set(FOUND_MODULES FALSE)
	foreach(arg in ${ARGV})
		if(arg STREQUAL MODULES)
			set(FOUND_MODULES TRUE)
		endif()
		if(FOUND_MODULES STREQUAL TRUE)
			list(APPEND NEEDED_MODULES ${arg})
		endif()
	endforeach()
	add_third_party_module(${TARGET_NAME} ${NEEDED_MODULES})
endmacro()
